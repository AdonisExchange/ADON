ADON Core version v5.1.0 is now available from:  <https://github.com/AdonisNetwork/ADON/releases>
...
- #2170 Better adon.conf Masternode data error notification (furszy)

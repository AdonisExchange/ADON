...
with certain assembly code from PIVX Core's code. See [developer notes on sanitizers](https://github.com/AdonisNetwork/ADON/blob/master/doc/developer-notes.md#sanitizers)

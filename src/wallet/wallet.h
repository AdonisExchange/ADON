...
#ifndef ADON_WALLET_H
#define ADON_WALLET_H
...
enum WalletFeature {
    ...
    FEATURE_PRE_ADON = 61000, // inherited version..
...
public:
     ...
     * ADON: group coins by pair <CTxDestination, Optional<CTxDestination>>. The optional destination
    ...
    /// Get 10000 ADON output and keys which can be used for the Masternode
    ...
    bool CreateCoinstakeOuts(const CAdonStake& stakeInput, std::vector<CTxOut>& vout, CAmount nTotal) const;

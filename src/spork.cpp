...
// Copyright (c) 2016-2022 The ADON developers
...
std::vector<CSporkDef> sporkDefs = {
    MAKE_SPORK_DEF(SPORK_8_MASTERNODE_PAYMENT_ENFORCEMENT,  0), // ON
    MAKE_SPORK_DEF(SPORK_9_MASTERNODE_BUDGET_ENFORCEMENT,   0), // ON
    MAKE_SPORK_DEF(SPORK_13_ENABLE_SUPERBLOCKS,             0), // ON
    MAKE_SPORK_DEF(SPORK_14_NEW_PROTOCOL_ENFORCEMENT,       4070908800ULL), // OFF
    MAKE_SPORK_DEF(SPORK_15_NEW_PROTOCOL_ENFORCEMENT_2,     0), // ON
...
// ADON: on startup load spork values from previous session if they exist in the sporkDB

...
#include "qt/adon/forms/ui_masternodeswidget.h"

#include "qt/adon/qtutils.h"
#include "qt/adon/mnrow.h"
#include "qt/adon/mninfodialog.h"
#include "qt/adon/masternodewizarddialog.h"
...
MasterNodesWidget::MasterNodesWidget(ADONGUI *parent) :
    PWidget(parent),
...
void MasterNodesWidget::onCreateMNClicked()
{
    ...
    if (walletModel->getBalance() <= mnCollateralAmount) {
        inform(tr("Not enough balance to create a masternode, %1 required.")
            .arg(GUIUtil::formatBalance(mnCollateralAmount, BitcoinUnits::ADON)));
        return;
    }
    showHideOp(true);

...
bool openDialogWithOpaqueBackgroundY(QDialog* widget, ADONGUI* gui, double posX = 3, int posY = 5, bool hideOpaqueBackground = true);
bool openDialogWithOpaqueBackground(QDialog* widget, ADONGUI* gui, double posX = 3);

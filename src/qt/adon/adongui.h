...
#ifndef ADON_CORE_NEW_GUI_ADONGUI_H
#define ADON_CORE_NEW_GUI_ADONGUI_H
...
#include "qt/adon/navmenuwidget.h"
#include "qt/adon/topbar.h"
#include "qt/adon/dashboardwidget.h"
#include "qt/adon/send.h"
#include "qt/adon/receivewidget.h"
#include "qt/adon/addresseswidget.h"
#include "qt/adon/coldstakingwidget.h"
#include "qt/adon/governancewidget.h"
#include "qt/adon/masternodeswidget.h"
#include "qt/adon/snackbar.h"
#include "qt/adon/settings/settingswidget.h"
...
/**
  ADON GUI main class. This class represents the main window of the ADON UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class ADONGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit ADONGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~ADONGUI();
...
#endif //ADON_CORE_NEW_GUI_ADONGUI_H

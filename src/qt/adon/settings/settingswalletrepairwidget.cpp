...
#include "qt/adon/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/adon/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(ADONGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to ADONGUI::handleRestart()

...
#include "qt/adon/settings/settingsbackupwallet.h"
#include "qt/adon/settings/settingsexportcsv.h"
#include "qt/adon/settings/settingsbittoolwidget.h"
#include "qt/adon/settings/settingssignmessagewidgets.h"
#include "qt/adon/settings/settingswalletrepairwidget.h"
#include "qt/adon/settings/settingswalletoptionswidget.h"
#include "qt/adon/settings/settingsmainoptionswidget.h"
#include "qt/adon/settings/settingsdisplayoptionswidget.h"
#include "qt/adon/settings/settingsinformationwidget.h"
#include "qt/adon/settings/settingsconsolewidget.h"
...
public:
    explicit SettingsWidget(ADONGUI* parent);
    ~SettingsWidget();

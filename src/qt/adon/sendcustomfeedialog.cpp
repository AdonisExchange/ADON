...
#include "qt/adon/sendcustomfeedialog.h"
#include "qt/adon/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(ADONGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &ADONGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);

...
#include "qt/adon/topbar.h"
#include "qt/adon/forms/ui_topbar.h"
#include "qt/adon/lockunlock.h"
#include "qt/adon/qtutils.h"
#include "qt/adon/receivedialog.h"
#include "qt/adon/loadingdialog.h"
#include "askpassphrasedialog.h"

#include "bitcoinunits.h"
#include "qt/adon/balancebubble.h"
...
TopBar::TopBar(ADONGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopAdon, ui->labelAmountTopShieldedAdon}, "amount-small-topbar");
    setCssProperty({ui->labelAmountAdon}, "amount-topbar");
    setCssProperty({ui->labelPendingAdon, ui->labelImmatureAdon}, "amount-small-topbar");
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // ADON Total
    QString totalAdon = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);
    ...
    // ADON
    // Top
    ui->labelAmountTopAdon->setText(totalTransparent);
    ui->labelAmountTopShieldedAdon->setText(totalShielded);
    // Expanded
    ui->labelAmountAdon->setText(totalAdon);
    ui->labelPendingAdon->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance + newBalance.unconfirmed_shielded_balance, nDisplayUnit));
    ui->labelImmatureAdon->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}

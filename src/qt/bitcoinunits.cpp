...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(ADON);
    unitlist.append(mADON);
    unitlist.append(uADON);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    ...
    case ADON:
        return QString("adon");
    case mADON:
        return QString("madon");
    case uADON:
        return QString::fromUtf8("uadon");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZadon)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZADON)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZADON);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZADON)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZADON));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}

...
#error Client version information missing: version is not defined by adon-config.h or in any other way
#endif
...
/**
 * adond-res.rc includes this file, but it cannot cope with real c++ code.

...
class BlockIndexStatsTest(AdonTestFramework):
    ...
    def send_tx(self, node_from, node_to, fee, fFromShield, fToShield):
        if not fFromShield and not fToShield:
            ...
            # add 1 ADON "change" output 50% of the times
    ...
    def run_test(self):
        ...
        # miner creates 20 notes of 10 ADON + 9 notes of 5 ADON + 1 note of 4 ADON (using 1.0 fee)

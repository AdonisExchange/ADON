...
class ListReceivedTest (AdonTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 ADON.
        ...
        # Send 1 ADON to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 ADON sending them all (fee is 0.1 ADON)
        ...
        # Confirm transaction (2 ADON from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 ADON, send 0.6 ADON + 0.05 ADON fee

...
from test_framework.test_framework import AdonTier2TestFramework
...
class MasternodeGovernanceBasicTest(AdonTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposal = Proposal(
            "super-cool",
            "https://forum.adonis.networkt/test-proposal",
            2,

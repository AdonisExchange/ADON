...
COIN = 100000000 # 1 ADON in satoshis
...
# Objects that map to adond objects, which can be serialized/deserialized
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in adond indicates these should be deserialized as blocks

Contributing to ADON Core
============================

The ADON Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/AdonisNetwork/ADON/blob/master/doc/translation_process.md)
...
The following applies to code changes to the ADON Core project, and is not to be
confused with overall ADON Network Protocol consensus changes.

Whether a pull request is merged into ADON Core rests with the project merge
...
Patches that change ADON consensus rules are considerably more involved than
...
Where a patchset proposes to change the ADON consensus, it must have been
...
The project leader is the release manager for each ADON Core release.
